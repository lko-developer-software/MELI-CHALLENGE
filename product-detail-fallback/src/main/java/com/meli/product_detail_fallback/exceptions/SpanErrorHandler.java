...
public class SpanErrorHandler {
    ...
    public static void tagError(Span span, Exception ex) {
        ...
        if (span != null && ex != null) {
            ...
            if (ex instanceof com.meli.product_detail_fallback.exceptions.MeliException) {
                com.meli.product_detail_fallback.exceptions.MeliException meliEx = 
                    (com.meli.product_detail_fallback.exceptions.MeliException) ex;
