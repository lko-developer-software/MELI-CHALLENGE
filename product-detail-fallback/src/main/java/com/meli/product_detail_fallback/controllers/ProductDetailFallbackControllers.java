package com.meli.product_detail_fallback.controllers;
...
import com.meli.product_detail_fallback.annotations.GetAllProductDetails;
import com.meli.product_detail_fallback.annotations.GetProductDetailByProductId;
import com.meli.product_detail_fallback.annotations.ProductDetailController;
import com.meli.product_detail_fallback.annotations.ProductIdParameter;
...
import com.meli.product_detail_fallback.services.ProductDetailFallbackService;
...
public class ProductDetailFallbackControllers {

    @Autowired
    private ProductDetailFallbackService productDetailService;
    ...
    public ResponseEntity<?> getAllProductDetails() {
        ...
        Span span = tracer.nextSpan().name("ProductDetailFallbackControllers.getAllProductDetails").start();
        try {
    ...
    public ResponseEntity<?> getProductDetailByProductId(@ProductIdParameter @PathVariable String productId) {
        ...
        Span span = tracer.nextSpan().name("ProductDetailFallbackControllers.getProductDetailByProductId").start();
        try {
